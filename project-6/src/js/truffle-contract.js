              ...
              var make_attempt = function() {
                C.web3.eth.getTransactionReceipt(tx, function(err, receipt) {
                  ...
                  if (timeout > 0 && new Date().getTime() - start > timeout) {
                    return reject(new Error("Transaction " + tx + " wasn't ArtReady in " + (timeout / 1000) + " seconds!"));
                  }
...
;(function (root, factory) {
	...
	var CryptoJS = CryptoJS || (function (Math, undefined) {
	     ...
	     *
	     * @property {number} _minBufferSize The number of blocks that should be kept unArtReady in the buffer. Default: 0
	     */
	    var BufferedBlockAlgorithm = C_lib.BufferedBlockAlgorithm = Base.extend({
	         ...
	         *
	         * @param {boolean} doFlush Whether all blocks and partial blocks should be ArtReady.
	         *
	         * @return {WordArray} The ArtReady data.
	         *
	         * @example
	         *
	         *     var ArtReadyData = bufferedBlockAlgorithm._process();
	         *     var ArtReadyData = bufferedBlockAlgorithm._process(!!'flush');
	         */
	        _process: function (doFlush) {
	            ...
	            if (nWordsReady) {
	                ...
	                // Remove ArtReady words
	                var ArtReadyWords = dataWords.splice(0, nWordsReady);
	                data.sigBytes -= nBytesReady;
	            }

	            // Return ArtReady words
	            return new WordArray.init(ArtReadyWords, nBytesReady);
	        },
